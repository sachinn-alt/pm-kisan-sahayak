...
export function tablerIcon(name, size = 20, className = '', extraAttrs = '') {
  const iconPaths = {
    ...
    cloud: '<path d="M6.657 18c-2.572 0 -4.657 -2.007 -4.657 -4.483c0 -2.475 2.085 -4.482 4.657 -4.482c.393 -1.762 1.794 -3.2 3.675 -3.708c2.08 -.56 4.295 .185 5.569 1.872c1.789 -.28 3.542 .647 4.341 2.298c.8 1.65 .34 3.64 -1.116 4.783c.18 .56 .274 1.15 .274 1.74c0 2.476 -2.085 4.483 -4.657 4.483l-10.086 0z" />',
    cloudRain: '<path d="M7 18a4.6 4.4 0 0 1 0 -9a5 4.5 0 0 1 11 2h1a3.5 3.5 0 0 1 0 7" /><path d="M11 13v2m0 3v2m4 -5v2m0 3v2" />',
    cloudSun: '<path d="M8 10a4 4 0 1 0 8 0a4 4 0 0 0 -8 0" /><path d="M12 4v2m0 8v2m-6 -6h2m8 0h2m-7.07 -4.07l1.41 1.41m5.66 5.66l1.41 1.41m0 -7.07l-1.41 1.41m-5.66 5.66l-1.41 1.41" />',
    droplet: '<path d="M6.8 11a6 6 0 1 0 10.396 0l-5.197 -8l-5.2 8z" />',
    ...
    // Mandi & Market Trends
    trendingUp: '<path d="M3 17l6 -6l4 4l8 -8" /><path d="M14 7l7 0l0 7" />',
    trendingDown: '<path d="M3 7l6 6l4 -4l8 8" /><path d="M21 10l0 7l-7 0" />',
    buildingWarehouse: '<path d="M3 21v-13l9 -4l9 4v13" /><path d="M13 13h4v8H7v-6h6z" />',

    // Security & Anti-Fraud Radar
    shieldAlert: '<path d="M12 3a12 12 0 0 0 8.5 3a12 12 0 0 1 -8.5 15a12 12 0 0 1 -8.5 -15a12 12 0 0 0 8.5 -3" /><path d="M12 8v4" /><path d="M12 16h.01" />',
    alertOctagon: '<path d="M8.7 3h6.6c.7 0 1.3 .3 1.8 .8l4.1 4.1c.5 .5 .8 1.1 .8 1.8v6.6c0 .7 -.3 1.3 -.8 1.8l-4.1 4.1c-.5 .5 -1.1 .8 -1.8 .8h-6.6c-.7 0 -1.3 -.3 -1.8 -.8l-4.1 -4.1c-.5 -.5 -.8 -1.1 -.8 -1.8v-6.6c0 -.7 .3 -1.3 .8 -1.8l4.1 -4.1c.5 -.5 1.1 -.8 1.8 -.8z" /><path d="M12 8v4" /><path d="M12 16h.01" />',
    radar: '<path d="M21 12h-8a1 1 0 1 0 -1 1v8a9 9 0 0 0 9 -9" /><path d="M16 9a5 5 0 1 0 -7 7" /><path d="M20.486 9a9 9 0 1 0 -11.486 11.486" />',
    bug: '<path d="M9 9v10a3 3 0 0 0 6 0v-10" /><path d="M8 9h8" /><path d="M3 9l3 2" /><path d="M3 15l3 -2" /><path d="M21 9l-3 2" /><path d="M21 15l-3 -2" /><path d="M10 5a2 2 0 1 1 4 0" />',
...
// Official Government of India Lion Capital Emblem (Direct Golden Image)
export function emblemOfIndia(height = 42, className = '') {
  return `<img src="./emblem.png" class="govt-emblem-img ${className}" height="${height}" alt="State Emblem of India" loading="eager" />`;
}
