...
export const FARMERS = {
  ...
  '9876543211': {
    ...
    issueDetails: { title: 'Aadhaar-Bank Account Name Mismatch', explain: 'Your Aadhaar name and bank account name do not match exactly. The payment system pauses transfers until your records agree.', failedInstallment: 23, resolutionOptions: [{ title: 'Update name at your bank', icon: '🏦', time: '1–3 days', difficulty: 'Easy', steps: ['Take Aadhaar and passbook to your bank branch.', 'Ask for an account-name correction form.', 'Submit the form with your documents.', 'Confirm the updated name with the branch.', 'Check PM-KISAN status after a few days.'] }, { title: 'Update Aadhaar details', icon: '🪪', time: '30 minutes', difficulty: 'Need appointment', steps: ['Book an Aadhaar update appointment.', 'Carry proof of your correct name.', 'Request a demographic-name update.', 'Keep the acknowledgement slip.', 'Allow the update to reflect before retrying.'] }], documents: ['Aadhaar card', 'Bank passbook', 'Name-change proof, if applicable'] },
    installments: generateInstallments(20, 0, [21,22,23])
  },
  '9876543212': { name: 'Mohan Singh', regNumber: '345678901234', state: 'Rajasthan', district: 'Jaipur', village: 'Sanganer', aadhaarLast4: '6541', issue: null, installments: generateInstallments(23, 0, []) },
  '9876543213': {
    ...
    issueDetails: { title: 'Land Records Not Linked', explain: 'Your farm ownership records have not yet been linked to your PM-KISAN registration. The local Revenue Department must verify the record.', failedInstallment: 22, resolutionOptions: [{ title: 'Visit Patwari or Tehsildar office', icon: '📜', time: '1–2 visits', difficulty: 'Need to travel', steps: ['Bring your land record and PM-KISAN registration receipt.', 'Ask to seed your land record to PM-KISAN.', 'Verify your name and khasra details.', 'Keep the acknowledgement number.', 'Check your status after the office update.'] }], documents: ['Khatauni/Jamabandi land record', 'Aadhaar card', 'PM-KISAN registration receipt'] },
